...
%Straight Lines [id:da1750622684190264] 
\draw [color={rgb, 255:red, 74; green, 144; blue, 226 }  ,draw opacity=1 ]   (317,278) -- (466.96,30.71) ;
\draw [shift={(468,29)}, rotate = 481.23] [color={rgb, 255:red, 74; green, 144; blue, 226 }  ,draw opacity=1 ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;
%Straight Lines [id:da692464235290007] 
\draw [color={rgb, 255:red, 74; green, 144; blue, 226 }  ,draw opacity=1 ]   (384,285) -- (451.49,27.93) ;
\draw [shift={(452,26)}, rotate = 464.71] [color={rgb, 255:red, 74; green, 144; blue, 226 }  ,draw opacity=1 ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;

% Text Node
\draw (282.13,281.95) node [anchor=north west][inner sep=0.75pt]   [align=left] {$\displaystyle O$};
% Text Node
\draw (541.48,334.26) node [anchor=north west][inner sep=0.75pt]   [align=left] {$\displaystyle \textcolor[rgb]{0.82,0.01,0.11}{\alpha }$};
% Text Node
\draw (317.75,391.65) node [anchor=north west][inner sep=0.75pt]   [align=left] {$\displaystyle \vec{k}_{0}$};
% Text Node
\draw (266.55,198.64) node [anchor=north west][inner sep=0.75pt]   [align=left] {$\displaystyle L_{0}$};
% Text Node
\draw (321.94,263.12) node [anchor=north west][inner sep=0.75pt]  [color={rgb, 255:red, 126; green, 211; blue, 33 }  ,opacity=1 ] [align=left] {$\displaystyle \vec{\textcolor[rgb]{0.49,0.83,0.13}{h}}$};
% Text Node
\draw (385.5,189.34) node [anchor=north west][inner sep=0.75pt]   [align=left] {$\displaystyle \textcolor[rgb]{0.29,0.56,0.89}{\vec{k}}\textcolor[rgb]{0.29,0.56,0.89}{'}\textcolor[rgb]{0.29,0.56,0.89}{_{h}}$};
% Text Node
\draw (417.23,371.41) node [anchor=north west][inner sep=0.75pt]   [align=left] {$\displaystyle \overrightarrow{k'}_{0}$};
% Text Node
\draw (286.56,396.74) node [anchor=north west][inner sep=0.75pt]   [align=left] {$\displaystyle \textcolor[rgb]{0.96,0.65,0.14}{\vec{\textcolor[rgb]{0.96,0.65,0.14}{n}}}$};
% Text Node
\draw (396.85,378.4) node [anchor=north west][inner sep=0.75pt]   [align=left] {$\displaystyle \textcolor[rgb]{0.96,0.65,0.14}{\vec{\textcolor[rgb]{0.96,0.65,0.14}{n}}}\textcolor[rgb]{0.96,0.65,0.14}{'}$};
% Text Node
\draw (319.21,204.51) node [anchor=north west][inner sep=0.75pt]   [align=left] {$\displaystyle \textcolor[rgb]{0.29,0.56,0.89}{\vec{k}}\textcolor[rgb]{0.29,0.56,0.89}{_{h}}$};
% Text Node
\draw (408.98,238.83) node [anchor=north west][inner sep=0.75pt]  [color={rgb, 255:red, 126; green, 211; blue, 33 }  ,opacity=1 ] [align=left] {$\displaystyle \overrightarrow{\textcolor[rgb]{0.49,0.83,0.13}{h'}}$};
% Text Node
\draw (220.44,166.03) node [anchor=north west][inner sep=0.75pt]   [align=left] {$\displaystyle \textcolor[rgb]{0.55,0.34,0.16}{R}$};
% Text Node
\draw (351.95,280.58) node [anchor=north west][inner sep=0.75pt]   [align=left] {$\displaystyle \textcolor[rgb]{0.82,0.01,0.11}{s}$};
% Text Node
\draw (296.48,382.46) node [anchor=north west][inner sep=0.75pt]   [align=left] {$\displaystyle \textcolor[rgb]{0.82,0.01,0.11}{\varphi }\textcolor[rgb]{0.82,0.01,0.11}{_{0}}$};
% Text Node
\draw (306.88,327.46) node [anchor=north west][inner sep=0.75pt]   [align=left] {$\displaystyle \textcolor[rgb]{0.82,0.01,0.11}{\varphi }\textcolor[rgb]{0.82,0.01,0.11}{_{h}}$};
% Text Node
\draw (262.13,8.95) node [anchor=north west][inner sep=0.75pt]   [align=left] {$\displaystyle S$};
% Text Node
\draw (439.13,70.95) node [anchor=north west][inner sep=0.75pt]   [align=left] {$\displaystyle F$};

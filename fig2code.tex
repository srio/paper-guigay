...
% Text Node
\draw (543.48,337.26) node [anchor=north west][inner sep=0.75pt]   [align=left] {$\displaystyle \textcolor[rgb]{0.82,0.01,0.11}{\alpha }$};
% Text Node
\draw (319.75,394.65) node [anchor=north west][inner sep=0.75pt]   [align=left] {$\displaystyle \vec{k}_{0}$};
% Text Node
\draw (268.55,201.64) node [anchor=north west][inner sep=0.75pt]   [align=left] {$\displaystyle L_{0}$};
% Text Node
\draw (323.94,266.12) node [anchor=north west][inner sep=0.75pt]  [color={rgb, 255:red, 126; green, 211; blue, 33 }  ,opacity=1 ] [align=left] {$\displaystyle \vec{\textcolor[rgb]{0.49,0.83,0.13}{h}}$};
% Text Node
\draw (387.5,192.34) node [anchor=north west][inner sep=0.75pt]   [align=left] {$\displaystyle \textcolor[rgb]{0.29,0.56,0.89}{\vec{k}}\textcolor[rgb]{0.29,0.56,0.89}{'}\textcolor[rgb]{0.29,0.56,0.89}{_{h}}$};
% Text Node
\draw (419.23,374.41) node [anchor=north west][inner sep=0.75pt]   [align=left] {$\displaystyle \overrightarrow{k'}_{0}$};
% Text Node
\draw (288.56,399.74) node [anchor=north west][inner sep=0.75pt]   [align=left] {$\displaystyle \textcolor[rgb]{0.96,0.65,0.14}{\vec{\textcolor[rgb]{0.96,0.65,0.14}{n}}}$};
% Text Node
\draw (398.85,381.4) node [anchor=north west][inner sep=0.75pt]   [align=left] {$\displaystyle \textcolor[rgb]{0.96,0.65,0.14}{\vec{\textcolor[rgb]{0.96,0.65,0.14}{n}}}\textcolor[rgb]{0.96,0.65,0.14}{'}$};
% Text Node
\draw (321.21,207.51) node [anchor=north west][inner sep=0.75pt]   [align=left] {$\displaystyle \textcolor[rgb]{0.29,0.56,0.89}{\vec{k}}\textcolor[rgb]{0.29,0.56,0.89}{_{h}}$};
% Text Node
\draw (222.44,169.03) node [anchor=north west][inner sep=0.75pt]   [align=left] {$\displaystyle \textcolor[rgb]{0.55,0.34,0.16}{R}$};
% Text Node
\draw (353.95,283.58) node [anchor=north west][inner sep=0.75pt]   [align=left] {$\displaystyle \textcolor[rgb]{0.82,0.01,0.11}{s}$};
% Text Node
\draw (298.48,385.46) node [anchor=north west][inner sep=0.75pt]   [align=left] {$\displaystyle \textcolor[rgb]{0.82,0.01,0.11}{\varphi }\textcolor[rgb]{0.82,0.01,0.11}{_{0}}$};
% Text Node
\draw (308.88,330.46) node [anchor=north west][inner sep=0.75pt]   [align=left] {$\displaystyle \textcolor[rgb]{0.82,0.01,0.11}{\varphi }\textcolor[rgb]{0.82,0.01,0.11}{_{h}}$};
% Text Node
\draw (264.13,11.95) node [anchor=north west][inner sep=0.75pt]   [align=left] {$\displaystyle S$};
% Text Node
\draw (441.13,73.95) node [anchor=north west][inner sep=0.75pt]   [align=left] {$\displaystyle F$};
% Text Node
\draw (362.13,285.95) node [anchor=north west][inner sep=0.75pt]   [align=left] {$\displaystyle P$};

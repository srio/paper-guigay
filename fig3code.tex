...
%Straight Lines [id:da19884360454908312] 
\draw    (455,207) -- (493,207) ;
\draw [shift={(495,207)}, rotate = 180] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;
%Straight Lines [id:da7905673067566117] 
\draw    (456,207) -- (456,246) ;
\draw [shift={(456,248)}, rotate = 270] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;

% Text Node
\draw (291,86) node [anchor=north west][inner sep=0.75pt]   [align=left] {$\displaystyle O$};
% Text Node
\draw (435,29) node [anchor=north west][inner sep=0.75pt]   [align=left] {$\displaystyle \textcolor[rgb]{0.29,0.56,0.89}{\tau }$};
% Text Node
\draw (336,238) node [anchor=north west][inner sep=0.75pt]   [align=left] {$\displaystyle \textcolor[rgb]{0.29,0.56,0.89}{\xi }$};
% Text Node
\draw (259,141) node [anchor=north west][inner sep=0.75pt]   [align=left] {$\displaystyle -a$};
% Text Node
\draw (309,203) node [anchor=north west][inner sep=0.75pt]   [align=left] {$\displaystyle a$};
% Text Node
\draw (293,24) node [anchor=north west][inner sep=0.75pt]   [align=left] {$\displaystyle \vec{k}_{0}$};
% Text Node
\draw (379,248) node [anchor=north west][inner sep=0.75pt]   [align=left] {$\displaystyle s_{0}$};
% Text Node
\draw (120,225) node [anchor=north west][inner sep=0.75pt]   [align=left] {$\displaystyle s_{h}$};
% Text Node
\draw (134,260) node [anchor=north west][inner sep=0.75pt]   [align=left] {$\displaystyle \textcolor[rgb]{0.82,0.01,0.11}{q}$};
% Text Node
\draw (218,137) node [anchor=north west][inner sep=0.75pt]   [align=left] {$\displaystyle \vec{k}_{h}$};
% Text Node
\draw (228,73) node [anchor=north west][inner sep=0.75pt]  [color={rgb, 255:red, 126; green, 211; blue, 33 }  ,opacity=1 ] [align=left] {$\displaystyle \vec{\textcolor[rgb]{0.49,0.83,0.13}{h}}$};
% Text Node
\draw (443,133) node [anchor=north west][inner sep=0.75pt]   [align=left] {$\displaystyle t$};
% Text Node
\draw (289.13,174) node [anchor=north west][inner sep=0.75pt]   [align=left] {$\displaystyle O'$};
% Text Node
\draw (497,196) node [anchor=north west][inner sep=0.75pt]   [align=left] {$\displaystyle x$};
% Text Node
\draw (450,251) node [anchor=north west][inner sep=0.75pt]   [align=left] {$\displaystyle z$};
